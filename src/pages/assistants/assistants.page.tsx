...
const AssistantsPage = () => {
  const assistants = [
    ...
    {
      name: 'Индира',
      type: 'Психолог-ассистент',
      photo: indira,
      duties: [
        'Поддержит в стрессовых ситуациях',
        'Поможет выговориться и найти баланс',
        'Подскажет, куда обратиться при выгорании',
        'Я Здесь, чтобы вы чувствовали себя лучше.',
      ],
      action: 'Начать диалог',
      isDisabled: true,
    },
